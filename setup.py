...
setup(
  name = 'libname',         # How you named your package folder (MyLib)
  packages = ['libname'],   # Chose the same as "name"
  ...
  classifiers=[
    ...
    'Intended Audience :: Archivers',      # Define that your audience are developers
